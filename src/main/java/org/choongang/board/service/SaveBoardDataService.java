...
public class SaveBoardDataService {
    ...
    public void deleteAll() { 
        ...
        List<SaveBoardData> items = (List<SaveBoardData>) saveBoardDataRepository
            .findAll(saveBoardData.mSeq.eq(memberUtil.getMember().getSeq()));
    ...
    public ListData<BoardData> getList(BoardDataSearch search) {
        ...
        List<Long> bSeqs = saveBoardDataRepository.getBoardDataSeq(member.getSeq());
